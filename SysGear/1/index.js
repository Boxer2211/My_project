...
function showContaainer(){
    document.getElementById('container__add').style= "display: flex";
}
...
function addNewParams(){
    ...
    const valM = document.querySelector('#valM').value;
    const valCm = document.querySelector('#valCm').value;
    const valIn = document.querySelector('#valIn').value;
    const valFt = document.querySelector('#valFt').value;
   ...
   conversionRules.params[name1] = arr
   
    alert('New conversion added!')
    document.getElementById('container__add').style= "display: none";
